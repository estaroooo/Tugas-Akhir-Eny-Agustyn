...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE user SET nim='$nim', nama='$nama', jenis_kelamin='$jenis_kelamin', jurusan='$jurusan', alamat='$alamat' WHERE id=$id";
    $query = mysqli_query($conn, $sql);
    ...
    if ($query && $query3) {
        $sukses = "Data Anda berhasil diupdate";
    } else {
        $error = "Data Anda gagal diupdate";
    }
}
